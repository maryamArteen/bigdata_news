...
def get_demo_prediction(headline):
    ...
    strong_fake_indicators = ['breaking news:', 'shocking:', 'blood on their hands', 'secret plan', 'major problem', 'conspiracy', 'exposed by', 'truth about', 'coverup']
    
    # Real news indicators
    real_indicators = ['officials announce', 'parliament votes', 'government', 'committee', 'department', 'ministry']
